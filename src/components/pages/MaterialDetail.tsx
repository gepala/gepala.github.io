...
const materialsData: Record<string, MaterialData> = {
  'paljal-palbal': {
    ...
    description: 'Materi lengkap tentang persiapan sebelum melakukan perjalanan alam',
    sections: [
      {
        title: 'Perlengkapan',
        subsections: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <Badge className="bg-yellow-500 text-black">Materi Kepecintaalaman</Badge>
            </div>
